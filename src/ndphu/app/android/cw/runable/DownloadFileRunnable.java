package ndphu.app.android.cw.runable;
...
//	}
	...
	public void run() {
		...
		try {
			...
			int downloadedSize = IOUtils.copy(response.getEntity().getContent(), new FileOutputStream(getDestination()));
//			if (mListener != null && mListener.get() != null) {
//				mListener.get().onCompleted(getUrl(), getDestination(), downloadedSize);
//			}
			if (mListener != null) {
